				...
				?>
								...
								<table class="table table-bordered table-striped mb-none" id="datatable-details">
                                    ...
                                    <?php
										...
										$ids_especificos = array(26); // Lista de IDs específicos que você deseja visualizar
