    ...
    <div class="inner-wrapper">
        ...
        <section role="main" class="content-body">
            <header class="page-header">
                <h2>Familiar Espinho</h2>

                <div class="right-wrapper pull-right">
                    <ol class="breadcrumbs" style=" margin-right: 30px;">
                        
                        <li><span>Familiar Espinho</span></li>
                    </ol>
                </div>
            </header>
...
?>
    ...
    <body>
    <!-- Botão que redireciona para a página http://localhost/mixtime/index.php?pagina=teste4 -->
    <button onclick="window.location.href = 'http://localhost/mixtime/index.php?pagina=teste4'" class="btn-blue">Ir para a empresa</button>
</body>
