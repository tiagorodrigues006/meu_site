			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					<header class="page-header">
						<h2>Intervenções Bioergos/Estervalor</h2>
					
						<div class="right-wrapper pull-right" style="padding-right: 30px">
							<ol class="breadcrumbs">
								
								<li><span>Imperio Bioergos/Estervalor </span></li>
								<li><span>Intervenções Bioergos/Estervalor</span></li>
							</ol>
				...
				?>
								...
								<table class="table table-bordered table-striped mb-none" id="datatable-details">
                                    ...
                                    <?php
										...
										$ids_especificos = array(28); // Lista de IDs específicos que você deseja visualizar
