			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					<header class="page-header">
						<h2>Intervenções Registadas Moduscomplete</h2>
					
						<div class="right-wrapper pull-right" style="padding-right: 30px">
							<ol class="breadcrumbs">
								
								<li><span>Empresa Moduscomplete </span></li>
								<li><span>Intervenções Registadas Moduscomplete</span></li>
				...
				?>
								...
								<table class="table table-bordered table-striped mb-none" id="datatable-details">
                                    ...
                                    <?php
										...
										$ids_especificos = array(39, 33, 29, 23, 19, 12); // Lista de IDs específicos que você deseja visualizar
