...
?>
    ...
    <body>
    <!-- Botão que redireciona para a página http://localhost/mixtime/index.php?pagina=teste1 -->
    <button onclick="window.location.href = 'http://localhost/mixtime/index.php?pagina=teste1';" class="btn-blue">Ir para a empresa</button>
</body>
