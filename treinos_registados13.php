...
?>
    ...
    <body>
    <!-- Botão que redireciona para a página http://localhost/mixtime/index.php?pagina=teste14 -->
    <button onclick="window.location.href = 'http://localhost/mixtime/index.php?pagina=teste14'" class="btn-blue">Ir para a empresa</button>
</body>
