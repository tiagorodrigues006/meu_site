    ...
    <div class="inner-wrapper">
        ...
        <section role="main" class="content-body">
            <header class="page-header">
                <h2>Hostel da Praça</h2>

                <div class="right-wrapper pull-right">
                    <ol class="breadcrumbs" style=" margin-right: 30px;">
                       
                        <li><span>Hostel da Praça</span></li>
                    </ol>
                </div>
            </header>
...
?>
    ...
    <body>
    <!-- Botão que redireciona para a página http://localhost/mixtime/index.php?pagina=teste12 -->
    <button onclick="window.location.href = 'http://localhost/mixtime/index.php?pagina=teste12'" class="btn-blue">Ir para a empresa</button>
</body>
