...
?>
    ...
    <body>
    <!-- Botão que redireciona para a página http://localhost/mixtime/index.php?pagina=teste13 -->
    <button onclick="window.location.href = 'http://localhost/mixtime/index.php?pagina=teste13'" class="btn-blue">Ir para a empresa</button>
</body>
