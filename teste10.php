		...
		<section class="body">
			...
			<section role="main" class="content-body">
					<header class="page-header">
						<h2>Intervenções Clinica Dentaria Dra Cristina</h2>
					
						<div class="right-wrapper pull-right" style="padding-right: 30px">
							<ol class="breadcrumbs">
								
								<li><span>Clinica Dentaria Dra Cristina </span></li>
								<li><span>Intervenções Clinica Dentaria Dra Cristina</span></li>
							</ol>
				...
				?>
								...
								<table class="table table-bordered table-striped mb-none" id="datatable-details">
                                    ...
                                    <?php
										...
										$ids_especificos = array(25); // Lista de IDs específicos que você deseja visualizar
